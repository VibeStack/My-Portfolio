...
export default function LatestWorks() {
  ...
  return (
    <>
      <section
        ref={scrollRef}
        className="max-w-screen mx-auto px-10 md:px-15 lg:px-40 relative pb-8 sm:pb-16 bg-[#111] text-white"
      >
        <h2 className="text-3xl sm:text-[52px] bg-[#111] relative z-10 font-extrabold px-4 py-2 w-max mx-auto text-center text-[#5a189a] sm:border-b-2 border-[#9d4edd] font-['Nunito'] opacity-75 transition-all hover:opacity-100 hover:scale-150 sm:hover:scale-110 duration-500 ease-in-out">
          Latest Works
        </h2>
        ...
        <div className="w-[2px] hidden sm:block bg-[#222] absolute top-0 bottom-0 left-1/2 -translate-x-1/2" />
      </section>
    </>
  );
}
